...
//			else if(ucUartBuf[1]  == CMD_HANDSHAKE)					//pc tool handshake
//			{
//				if(ucUartBufPT == 4)
//				{
//					ucUartBufPT = 0;
...
//			if((FLASHCON&0x01) == 0)
//			{
//				UartDataLen = CODE_SECTOR*1024;
//				XPAGE = ucUartBuf[8]<<2;					//Code Area
//			}
//			else
			{
